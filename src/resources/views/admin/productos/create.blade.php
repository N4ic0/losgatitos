...
<div class="max-w-2xl">
    ...
    <div class="modal fade" id="categoriasModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-[#1a1a1a] rounded-2xl p-8 border border-white/10 shadow-2xl">
                <h3 class="text-xl font-bold text-white mb-6">Gestionar Categorías</h3>

                <div id="categoriasList" class="space-y-3 mb-6">
                </div>

                <div class="border-t border-white/10 pt-4">
                    <label class="block text-gray-300 text-sm font-medium mb-2">Nueva Categoría</label>
                    <div class="flex space-x-3">
                        <input type="text" id="nuevaCategoriaNombre" placeholder="Nombre" class="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-[#D4AF37] outline-none text-sm">
                ...
                <div class="flex justify-end pt-4">
                    <button type="button" data-bs-dismiss="modal" class="px-6 py-3 text-gray-400 hover:text-white transition-colors text-sm">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
